...
func SeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if seguidorID == usuarioID {
		resposta.Erro(w, http.StatusForbidden, errors.New("não é possível seguir você mesmo"))
		return
	}
...
func PararDeSeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if seguidorID == usuarioID {
		resposta.Erro(w, http.StatusForbidden, errors.New("não é possível parar de seguir você mesmo"))
		return
	}
...
func BuscarSeguidores(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioDeUsuarios(db)
	seguidores, erro := repositorio.BuscarSeguidores(id)
	if erro != nil {
		resposta.Erro(w, http.StatusInternalServerError, erro)
		return
	}
